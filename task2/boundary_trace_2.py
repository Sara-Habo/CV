...
##(image , start point ,end point ,color ,thikness)  if -1 make this color for whole selected size
# img1= cv2.rectangle(black_background, (200, 200), (400, 400),(256, 256, 256), -1)
##set shape
p1 = (220, 220)
p2 = (220, 380)
p3 = (380, 300)
...
image = cv2.imread("C:/Users/NADER/Downloads/trace_4.png")
